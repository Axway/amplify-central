...
| Where are the invoices visible in Amplify Platform?                                   | As a provider, you can view all invoices related to subscription using one of the products your team is managing by navigating to Amplify Central > Marketplace > Invoices. In case there is an error, you will see it there. If there is no error, you will be able to access the invoice details. |
