---
title: Amplify Engage July 13 2026
linkTitle: Amplify Engage July 13 2026
weight: 14
date: 2026-7-7
---

**Feedback Window**: June 13 2026 → July 20 2026 <br />
...
* **Amplify Engage V1 API support**
  ...
  The Amplify Engage APIs have added support for v1 APIs in addition to v1alpha1. The v1 APIs are functionally equivalent to the v1alpha APIs. In some cases, efficiency improvements have been made to reduce the amount of data returned by default (e.g., metadata ACLs in Authorization profiles).
