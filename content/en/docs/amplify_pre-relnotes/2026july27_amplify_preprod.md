---
title: Amplify Engage July 27 2026
linkTitle: Amplify Engage July 27 2026
weight: 13
date: 2026-7-7
---

**Feedback Window**: July 27 2026 → August 3 2026 <br />
...
* **Long name display handling**
  ...
  The Topology -> Environments and Topology -> Compliance Profiles UI tables have been improved for the handling of long names. Here is a list of the improvements:
...
|         | APIGOV-31827 | **Issue**: A duplicate side blade component in the Marketplace UI was always rendered, causing unnecessary API requests on pages where the side panel was not opened. <br/>**Resolution**: The duplicate component has been replaced with a lazy-loaded implementation that only makes API requests when the panel is opened. |
|         | APIGOV-33186 | **Issue**: The create document wizard was not assigning the Access Control List (ACL) values. <br/>**Resolution**: The create wizard now assigns the ACLs. |
|         | APIGOV-33260 | **Issue**: The display of a **draft** asset was not showing **Out of Sync** APIs on the Linked Resources tab. <br/>**Resolution**: The Linked Resources tab shows the **Out of Sync** APIs so they can be removed from the draft asset. |
