...
10. (Optional step) Provide Terms and Conditions for your consumer to approve while subscribing. The list of existing documents from the Document Library that are visible from a Marketplace is displayed. Select the one corresponding to the product Terms & Conditions by clicking the corresponding radio button. If you made a mistake, use the **Reset** button to unselect a document and select another document. Click **Next**.
