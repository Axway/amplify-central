...
At the time of the subscription, it is optional to ask extra information from your consumer. For that you have to select one of the predefined [subscription screen definition](/docs/integrate_with_central/customize_ard_crd#customize-subscription-screen) from the Dropdown.
