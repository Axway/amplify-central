...
description: Amplify Central enables you to provide universal API Management across your enterprise. It allows you to manage and govern APIs and integration assets across all environments, clouds and API Gateways (Axway and non-Axway) through a [central management plane](#management-plane).
---  
...
![Amplify functionality](/Images/central/functionality.png)
...
### Data plane - Amplify agents

Amplify agents are lightweight software applications that run on your data plane host. The agents are responsible for gathering information that is happening in your data plane and sending it to the Amplify platform. The following two types of agents are available and the information that they gather:
