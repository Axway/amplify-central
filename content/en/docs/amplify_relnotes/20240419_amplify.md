...
**Metric Logs** - The Agent SDK has been enhanced with the addtion of two additional audit logs.  
- A metric audit log has been added and enabled by default to track the metric events the traceability agent has created based off traffic through the gateway.
