...
* **Unstructured API Service** - Fixed an issue with the discovery of unstructured APIs from an Azure Gateway.
...
* **Apigee X Gateway Support** - The add Environment wizard now has support for the Embedded Apigee X Agents.  In addition, the Axway Central CLI has been updated to support the installation of the Embedded Apigee X Agents (https://www.npmjs.com/package/@axway/axway-central-cli/v/2.17.0).  
