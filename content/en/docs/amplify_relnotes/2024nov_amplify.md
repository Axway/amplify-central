...
|-------------|--------------|---------------------------------------------------|
| 01656035 | APIGOV-29220 | **Issue**: Marketplace footer issue <br/>**Resolution**: Footer does no more overlap the resource list when large number of resource is available. |
