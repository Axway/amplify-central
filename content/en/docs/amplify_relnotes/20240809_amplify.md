...
| Azure latest release                       | DA=v1.3.0 / TA=v1.3.0    | DA=v1.1.70 / TA=v1.1.76          |
...
* **Marketplace only support** - Agent SDK version 1.1.94 or lateer only has support for the Marketplace.  Prior Agent SDK versions no longer support the Unified Catalog.
