...
| API Gateway version                        | On-premise Agent version | Minimum supported Agent version |
|--------------------------------------------|--------------------------|------------------|
...
| Runtime Compliance Agents                  | On-premise Agent version | Minimum supported Agent version |
|--------------------------------------------|--------------------------|------------------|
