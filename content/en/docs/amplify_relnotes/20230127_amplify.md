...
* **Product plan tags and attributes** - Tags and attributes for product plans can now be viewed and edited in the Product Foundry UI.

#### Bug fixes for Product Foundry

* **The Central / Marketplace page is loading continuously due to the consumer + subscriber roles** - The combination of these roles prevented the Product Foundry UI from loading.
...
* **Corrupted product does not show the warning icon in all Marketplaces** - The multi-Marketplaces prevented the warning icon from being seen in all Marketplaces. Now, when a product becomes corrupted, the warning icon is displayed regardless of which Marketplace the consumer is logged into.
