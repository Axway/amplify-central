...
| Case ID   | Internal ID  | Description                                       |
|-----------|--------------|---------------------------------------------------|
|             | APIGOV-27787 | **Issue**: Review title maximum size not respected. <br />**Resolution**: The ratings title is now limited to 350 characters and displayed correctly everywhere (ie. can be truncated if too long). |
