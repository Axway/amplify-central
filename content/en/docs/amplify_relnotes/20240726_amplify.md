...
* **External OAuth Identity Provider support** - The Agent SDK has support for external OAuth Identity Provider(s) for the on-premise and SaaS Azure Agents.
* **Azure EventHub support** - The Agend SDK has support for the Azure EventHub configuration.
