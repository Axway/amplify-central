...
* **Credential Request Method available for selection ** - The Agent SDK has updated the On-premise agent configuration to toggle between displaying or hiding the specific options within the OAuth credential Type dropdown menu on the Request Credential screen in the Marketplace. [Show / Hide OAuth Credential Type](https://docs.axway.com/bundle/amplify-central/page/docs/connect_manage_environ/marketplace_provisioning/index.html).
