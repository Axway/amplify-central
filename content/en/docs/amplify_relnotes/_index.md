...
## [Amplify Engage July 27 2026](/docs/amplify_relnotes/2026july_amplify/#july-23-2026)
...
| Environment type                           | Latest on-premise agent version <br />(based on Amplify Agents SDK 1.1.143 <br />unless otherwise noted) |
|--------------------------------------------|--------------------------|
| Axway API Management 7.7                   | DA=1.2.61 / TA=1.2.51    |
| AWS Gateway using SDK 2.0                  | 1.2.45                   |
| Azure latest release                       | 1.3.46                   |
| Istio 1.9.5                                | DA=1.1.44 / TA=2.1.41    |
| Apigee Edge                                | 1.0.39                   |
| Apigee X                                   | 1.4.32                   |
| Mulesoft Anypoint platform v3              | 1.2.48                   |
| IBM webMethods                             | 1.0.37 (SDK v1.1.141)    |
| Kong Gateway                               | 1.1.42                   |
| GitLab                                     | 1.1.42                   |
| Kafka Cluster                              | 1.1.35                   |
| IBM API Connect Gateway                    | 1.1.36                   |
| Backstage                                  | 1.0.38                   |
| SAP Integration Suite - API Management / API Portal | 1.0.24          |
| WSO2 API Manager 4.5.0                     | 1.0.24                   |
| Sensedia                                   | 1.0.16                   |
...
| Runtime Compliance agents                  | Latest on-premise agent version <br />(based on Amplify Agents SDK 1.1.143 unless otherwise noted)  |
|--------------------------------------------|--------------------------|
| Graylog API Security                       | 1.1.36                   |
| Traceable API Security                     | 2.0.22                   |
| Akamai API Security                        | 1.1.9                    |
...
| IBM API Connect Gateway                             | 1.1.35                   |
| Backstage                                           | 1.0.37                   |
...
| Akamai API Security                        | 1.1.8                    |

## [Amplify Engage May 14 2026](/docs/amplify_relnotes/2026may_amplify/#may-14-2026)
...
## [Amplify Engage May 7 2026](/docs/amplify_relnotes/2026may_amplify/#may-7-2026)

No agent updates. See April 16 2026 for latest supported agent versions.

## [Amplify Engage May 4 2026](/docs/amplify_relnotes/2026may_amplify/#may-4-2026)
...
## [Amplify Engage April 29 2026](/docs/amplify_relnotes/2026april_amplify/#april-29-2026)

No agent updates. See April 16 2026 for latest supported agent versions.

## [Amplify Engage April 16 2026](/docs/amplify_relnotes/2026april_amplify/#april-16-2026)
...
## [Amplify Engage April 7 2026](/docs/amplify_relnotes/2026april_amplify/#april-7-2026)

No agent updates. See April 2 2026 for latest supported agent versions.

## [Amplify Engage April 2 2026](/docs/amplify_relnotes/2026april_amplify/#april-2-2026)
...
No agent updates. See March 5 2026 for latest supported agent versions.

## [Amplify Engage March 5 2026](/docs/amplify_relnotes/2026march_amplify/#march-5-2026)
...
## [Amplify Engage January 29 2026](/docs/amplify_relnotes/2026jan_amplify/#january-29-2026)

No agent updates. See January 16 2026 for latest supported agent versions.

## [Amplify Engage January 26 2026](/docs/amplify_relnotes/2026jan_amplify/#january-26-2026)

No agent updates. See January 16 2026 for latest supported agent versions.

## [Amplify Engage January 23 2026](/docs/amplify_relnotes/2026jan_amplify/#january-23-2026)

No agent updates. See January 16 2026 for latest supported agent versions.

## [Amplify Engage January 16 2026](/docs/amplify_relnotes/2026jan_amplify/#january-16-2026)
