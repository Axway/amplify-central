...
| Environment type                        | Latest on-premise agent version <br />(based on Amplify Agents SDK v1.1.94 <br />unless otherwise note) | Minimum supported agent version <br />(based on Amplify Agents SDK v1.1.83) |
|--------------------------------------------|--------------------------|------------------|
...
| Azure latest release                       | DA=v1.1.75 / TA=v1.1.81 <br />(based on v1.1.92) | DA=v1.1.70 / TA=v1.1.76          |
| Istio 1.9.5                                | DA=v1.0.42 / TA=v2.0.87  <br />(based on v1.1.92) | DA=v1.0.36 / TA=v2.0.82          |
