...
* **Amplify Istio Agent** (helm chart version 0.69.0, Agent version 2.0.28): Add text
* **Amplify Apigee Agent** (version 0.0.6): Add text
* **Amplify Mulesoft Agent** (version 1.1.5): Add text
