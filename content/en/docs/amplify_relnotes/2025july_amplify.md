...
New enhancements and bug fixes for the July 28 update.
...
* **New Axway CLI v4.0.4 is available**
   ...
   *  A fix to the **Axway CLI returning not authorized error** listed under Marketplace bug fixes for July 28, 2025
