...
| Case ID     | Internal ID  | Description                                       |
|---------    |--------------|---------------------------------------------------|
| 01570727    | APIGOV-28012 | **Issue**: In some deployment situations, the Traceability agent cannot be deployed with a Kubernetes stateful set. <br />**Resolution**: The deployment option to use either a Stateful set or a Daemon set was introduced.  |
