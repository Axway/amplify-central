...
* **IdP Authentication methods** - An enhancement was made to add additional IdP authentication methods to support Finanacial Data Exchange standards.  The supported authentication method types are client_secret_basic, client_secret_post, client_secret_jwt, private_key_jwt, tls_client_auth and self_signed_tls_client_auth.
