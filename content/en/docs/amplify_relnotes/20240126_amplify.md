...
* **Number of products displayed doesn't match the displayed products** - When a product is in error (i.e., when all its resources are corrupted), the product count from the Browse product page was wrong. Now product in error are correctly excluded from the Browse product page / product count.
