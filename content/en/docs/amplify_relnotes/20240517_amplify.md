...
| 01567300    | APIGOV-27915 | **Issue**: The Traceability Agent was restarting with a concurrent map read and map error <br />**Resolution**: A fix was made to cuncurrent map reads and writes  |
