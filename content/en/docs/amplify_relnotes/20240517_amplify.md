...
|---------    |--------------|---------------------------------------------------|
| Case #      | Jira #       | **Issue title**: Issue Description and resolution <br />**Issue title**: Issue Description and resolution  |
...
| Case ID     | Internal ID  | Description                                       |
|---------    |--------------|---------------------------------------------------|
| Case #      | Jira #      | **Issue title**: Issue Description <br />**Issue title**: Issue Description  |
