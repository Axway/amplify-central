...
* **Consumer can subscribe to an archive plan** - Due to the introduction of the archive status, a consumer could select an archive plan when subscribing directly from the plan page. Now, a plan must be active for a consumer to subscribe to it.
