...
* **Stage support** - Stage has been added to support a use case where Providers want to be able to associate a stage with an Environment/API Service (e.g. dev or production lifecycle stage). A stage sub-menu within Toplogy can be used to create, edit, view and delete stages.  Any stage can be associated with multiple Environments.  The stage can be configured to be visibile for any Marketplace or team/user.
* * **Environment Stage support** - Stage(s) can be assoicated with any environment and the default stage can be configured for an environment. The default stage will be assigned to all API Services added to the environment. 
