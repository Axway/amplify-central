...
* **Stage support** - A stage sub-menu within Toplogy can be used to create, edit, view and delete stages.  Any stage can be associated with multiple Environments.  The stage can be configured to be visibile for any Marketplace or team/user.
