...
* **HTTP Basic not available when consumer wants to authorize** - The HTTP Basic is now available in the Authentication side blade to allow consumer selecting the appropriate application / credentials to test the API.
