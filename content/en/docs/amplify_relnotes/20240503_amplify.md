...
A new Graylog API Security agent is now available. This agent enables you to map yoiur runtime traffic against your managed API infrastructure and identify unmanaged apis. In addition, it allows you to visualize and report on operational and security problems, by integrationg with Graylog API Security. For more details, see [Manage your runtime compliance](/docs/runtime_security)
