...
* **OAuth Credential Updates** - OAuth credentials are now updated when a scope change to an API Proxy is detected.
...
* **SOAP API subscriptions** - The Discovery Agent has been enhanced to provision/de-provision credentials for Enterprise Marketplace subscriptions.

##### Bug fixes for Axway API Management Gateway Agent

* **OAuth Credential Updates** - The OAuth credentials now update whenever a scope change is detected to an API Proxy.
