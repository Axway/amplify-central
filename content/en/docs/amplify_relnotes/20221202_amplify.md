...
* **Accessing a marketplace after another one does not work** - When moving from one marketplace url to another marketplace, the connection is now reset and user has to log again.
