...
| Case ID   | Internal ID  | Description                                       |
|-----------|--------------|---------------------------------------------------|
| -         | APIGOV-28577 | **Issue**: PDF documents are not render correctly when browsing product documentation. <br />**Resolution**: The loading content API has been fixed and now PDF content is correctly loaded. |
