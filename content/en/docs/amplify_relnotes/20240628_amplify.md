...
| 01591849  | APIGOV-27945 | **Issue**: Marketplace Access Request allows multiple applications with the same name. <br />**Resolution**: The system will no longer create multiple applications for the same subscription and resource using the same application name, and will display an error message. |
