...
The latest version of the [Axway CLI is v3.2.14 on NPM](https://www.npmjs.com/package/@axway/axway/v/3.2.14). The following enhancements or bug fixes are available in this release.
...
There are no known limitations in his release.
