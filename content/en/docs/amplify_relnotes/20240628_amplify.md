...
The latest version of the [Axway CLI is v3.2.14 on NPM](https://www.npmjs.com/package/@axway/axway/v/3.2.14). There are no enhancements in this release.  There was an improvement to the installation of the Axway Central CLI made in the Axway CLI.
