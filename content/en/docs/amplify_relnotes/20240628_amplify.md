...
|             | APIGOV-28081 | **Issue**: An issue was found with offline mode traceability agent sending error messages with 'reportALLErrors' variable set to true. <br />**Resolution**: A fix was made to no longer send error message while in offline mode and ignore the 'reportAllErrors' variable set to true in this case. |
