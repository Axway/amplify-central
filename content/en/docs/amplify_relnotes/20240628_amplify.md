...
* **Mocking service** - A simulated API experience not tied to a product plan or quota can now be published to the Marketplace with a "MOCKED" state. *Marketplace > Resources tab > Methods tab*.
