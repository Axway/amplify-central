...
| Case ID     | Internal ID  | Description                                       |
|-------------|--------------|---------------------------------------------------|
|             | APIGOV-28228 | **Issue**: A mock endpoint could not be created for Runtime Managed APIs. <br />**Resolution**: A fex was made to allow the creation of mock endpoints for OAS2/OAS3 Runtime Managed APIs discovered by Agents. |
