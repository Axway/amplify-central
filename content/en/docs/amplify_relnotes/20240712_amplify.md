...
|-------------|--------------|---------------------------------------------------|
|             | APIGOV-28034 | **Issue**: An issue was found with the Traceability Agents where in some cases the event handling cause a consumer to not be correlated correctly to a transaction. <br />**Resolution**: A fix was made to properly correlate the consumer with the transaction. |
