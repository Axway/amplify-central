...
The Discovery Agent for Axway API Management 7.7 SPx provides the ability to control the OAuth credential Type dropdown values in the Marketplace based on environment variable configuration.
