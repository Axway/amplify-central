...
The Traceability Agent redacts and sanitizes information that is sent to Amplify Analytics to populate the API Traffic dashboard. Learn how you can control the information that is sent to Amplify Analytics by using the redaction configuration.
