...
To change the reporting interval for the On-premise Traeability Agent, use the `CENTRAL_USAGEREPORTING_USAGESCHEDULE` variable with either a second, minute or hour notation:
