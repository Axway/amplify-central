...
| Variable name (Variables require an index '_n') | Description                                                                                                                                                                                                                                                                                                                               |
| ----------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AGENTFEATURES_IDP_NAME                          | The name of the OAuth identity provider. Required. Valid characters are lowercase letters, numbers, and '-'. Must start with a letter.                                                                                                                                                                                                    |
...
| AGENTFEATURES_IDP_METADATAURL                   | The URL exposed by the OAuth authorization server to provide metadata information. Required.                                                                                                                                                                                                                                              |
...
| AGENTFEATURES_IDP_AUTH_TYPE                     | The type of authentication mechanism to be used. Required. (`accessToken`, `client`, `client_secret_basic`, `client_secret_post`, `client_secret_jwt`, `private_key_jwt`, `tls_client_auth`, `self_signed_tls_client_auth`)                                                                                                               |
| AGENTFEATURES_IDP_AUTH_ACCESSTOKEN              | The token (initial access token, Admin API Token, etc.) to be used by the Agent SDK to authenticate with the OAuth identity provider. Required if type is `accessToken`.                                                                                                                                                                  |
| AGENTFEATURES_IDP_AUTH_CLIENTID                 | The identifier of the client in the OAuth identity provider that can used to create new OAuth clients. Required if auth type is `client`, `client_secret_basic`, `client_secret_post`, `client_secret_jwt`, `private_key_jwt`, `tls_client_auth`, or `self_signed_tls_client_auth`                                                        |
| AGENTFEATURES_IDP_AUTH_CLIENTSECRET             | The secret for the client in the OAuth identity provider. Required if auth type is `client`, `client_secret_basic`, `client_secret_post`, or `client_secret_jwt`                                                                                                                                                                          |
...
| AGENTFEATURES_IDP_AUTH_PRIVATEKEY               | Path of the private key file to be used for `private_key_jwt` authentication. Required if auth type is `private_key_jwt`.                                                                                                                                                                                                                 |
| AGENTFEATURES_IDP_AUTH_PUBLICKEY                | Path of the public key file to be used for `private_key_jwt` authentication. Required if auth type is `private_key_jwt`.                                                                                                                                                                                                                  |
...
| AGENTFEATURES_IDP_SSL_ROOTCACERTPATH            | The path of the root CA certificate to be used for the mTLS connection.                                                                                                                                                                                                                                                                   |
| AGENTFEATURES_IDP_SSL_CLIENTCERTPATH            | The path of the client certificate to be used for the mTLS connection. Required if auth type is `tls_client_auth`, or `self_signed_tls_client_auth`                                                                                                                                                                                       |
| AGENTFEATURES_IDP_SSL_CLIENTKEYPATH             | The path of the client key to be used for the mTLS connection. Required if auth type is `tls_client_auth`, or `self_signed_tls_client_auth`                                                                                                                                                                                               |
