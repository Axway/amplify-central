...
| Variable name                                   | Description                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| AGENTFEATURES_IDP_NAME_{n}                       | The name of the OAuth identity provider.                                                                                                                                                                                                                                                                                                                                                                                                    |
| AGENTFEATURES_IDP_TITLE_{n}                      | The title of the Credential Request Definition that will be shown to consumers in Marketplace.                                                                                                                                                                                                                                                                                                                                              |
| AGENTFEATURES_IDP_TYPE_{n}                       | The type of OAuth identity provider (`generic`, `keycloak` or `okta`).                                                                                                                                                                                                                                                                                                                                                                      |
| AGENTFEATURES_IDP_METADATAURL_{n}                | The URL exposed by the OAuth authorization server to provide metadata information.                                                                                                                                                                                                                                                                                                                                                          |
| AGENTFEATURES_IDP_EXTRAPROPERTIES_{n}            | Additional properties to send in the client metadata when registering a new client.                                                                                                                                                                                                                                                                                                                                                         |
| AGENTFEATURES_IDP_REQUESTHEADERS_{n}             | Additional request headers to send in the request when registering a new client.                                                                                                                                                                                                                                                                                                                                                            |
| AGENTFEATURES_IDP_QUERYPARAMS_{n}                | Additional query parameters to send in the request when registering a new client.                                                                                                                                                                                                                                                                                                                                                           |
| AGENTFEATURES_IDP_AUTH_TYPE_{n}                  | The type of authentication mechanism to be used.                                                                                                                                                                                                                                                                                                                                                                                            |
| AGENTFEATURES_IDP_AUTH_ACCESSTOKEN_{n}           | The token (initial access token, Admin API Token, etc.) to be used by the Agent SDK to authenticate with the OAuth identity provider.                                                                                                                                                                                                                                                                                                       |
| AGENTFEATURES_IDP_AUTH_CLIENTID_{n}              | The identifier of the client in the OAuth identity provider that can used to create new OAuth clients.                                                                                                                                                                                                                                                                                                                                      |
| AGENTFEATURES_IDP_AUTH_CLIENTSECRET_{n}          | The secret for the client in the OAuth identity provider.                                                                                                                                                                                                                                                                                                                                                                                   |
| AGENTFEATURES_IDP_AUTH_CLIENTSCOPE_{n}           | Space-separated scopes to be used when requesting the access token from the authorization server.                                                                                                                                                                                                                                                                                                                                           |
| AGENTFEATURES_IDP_AUTH_PRIVATEKEY_{n}            | Path of the private key file to be used for `private_key_jwt` authentication.                                                                                                                                                                                                                                                                                                                                                               |
| AGENTFEATURES_IDP_AUTH_PUBLICKEY_{n}             | Path of the public key file to be used for `private_key_jwt` authentication.                                                                                                                                                                                                                                                                                                                                                                |
| AGENTFEATURES_IDP_AUTH_KEYPASSWORD_{n}           | Password for the private key.                                                                                                                                                                                                                                                                                                                                                                                                               |
| AGENTFEATURES_IDP_AUTH_TOKENSIGNINGMETHOD_{n}    | Algorithm used for signing the token.                                                                                                                                                                                                                                                                                                                                                                                                       |
| AGENTFEATURES_IDP_AUTH_USECACHEDTOKEN_{n}        | Boolean flag to enable / disable the agent to cache the token until the expiry of the access token.                                                                                                                                                                                                                                                                                                                                         |
| AGENTFEATURES_IDP_AUTH_USEREGISTRATIONTOKEN_{n}  | Boolean flag to enable / disable the agent to save and use the Credential specific registration token when modifying the client in the IDP.                                                                                                                                                                                                                                                                                                 |
| AGENTFEATURES_IDP_AUTH_REQUESTHEADERS_{n}        | Additional request headers to send in the request for getting token.                                                                                                                                                                                                                                                                                                                                                                        |
| AGENTFEATURES_IDP_AUTH_QUERYPARAMS_{n}           | Additional query parameters to send in the request for getting token.                                                                                                                                                                                                                                                                                                                                                                       |
| AGENTFEATURES_IDP_SSL_NEXTPROTOS_{n}             | An array of strings. It is a list of supported application level protocols, in order of preference, based on the ALPN protocol list. Allowed values are: h2, http/1.0, http/1.1, h2c.                                                                                                                                                                                                                                                       |
| AGENTFEATURES_IDP_SSL_CIPHERSUITES_{n}           | An array of strings. It is a list of supported cipher suites for TLS versions up to TLS 1.2. If CipherSuites is nil, a default list of secure cipher suites is used, with a preference order based on hardware performance. See [Supported Cipher Suites](/docs/connect_manage_environ/connected_agent_common_reference/agent_security/).                                                                                                   |
| AGENTFEATURES_IDP_SSL_INSECURESKIPVERIFY_{n}     | Controls whether a client verifies the server's certificate chain and host name. If true, TLS accepts any certificate presented by the server and any host name in that certificate. In this mode, TLS is susceptible to man-in-the-middle attacks.                                                                                                                                                                                         |
| AGENTFEATURES_IDP_SSL_MAXVERSION_{n}             | String value for the maximum SSL/TLS version that is acceptable. If empty, then the maximum version supported by this package is used, which is currently TLS 1.3. Allowed values are: TLS1.0, TLS1.1, TLS1.2, TLS1.3.                                                                                                                                                                                                                      |
| AGENTFEATURES_IDP_SSL_MINVERSION_{n}             | String value for the minimum SSL/TLS version that is acceptable. If zero, empty TLS 1.2 is taken as the minimum. Allowed values are: TLS1.0, TLS1.1, TLS1.2, TLS1.3.                                                                                                                                                                                                                                                                        |
| AGENTFEATURES_IDP_OKTA_GROUP_{n}   | (okta specific) Name of an existing Okta group to assign the registered OAuth client to. The group must already exist in Okta.                                  |
| AGENTFEATURES_IDP_OKTA_POLICY_{n}  | (okta specific) Name of an existing Okta authorization server policy to which the registered OAuth client will be added. The policy must already exist in Okta. |
| AGENTFEATURES_MANAGEIDPRESOURCES  | Set to true to enable the agent to automatically create and manage `IdentityProvider` and `IdentityProviderMetadata` resources in Engage from the agent's IDP configuration. When enabled, the agent looks up existing resources by IDP metadata endpoints before creating new ones, allowing multiple environments that share the same OAuth authorization server to reuse a single `IdentityProvider` resource (default: `false`). See [Unified credential management across environments with a shared identity provider](/docs/connect_manage_environ/marketplace_provisioning/#unified-credential-management-across-environments-with-a-shared-identity-provider). |
