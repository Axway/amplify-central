...
| AGENTFEATURES_IDP_EXTRAPROPERTIES           | Additional propertiers to send in the client metadata when registering a new client.                                                                                                                                                                                                                                                      |
...
| TRACEABILITY_SAMPLING_PERCENTAGE               | The percentage of all transactions that are sent to Amplify. A value of `0` reports no traffic (default value `1`), maximum value `10`. If the value is set higher than the maximum value, then the agent will use the default value.                                                                                           |
