...
1. A consumer initiates the subscription in Amplify web UI:
   ...
   2. Click **Subscribe**.
   3. Select the Team and API Manager Application name / Usage Plan for which you want to subscribe. For additional information, see [Manage Amplify Catalog subscriptions.](/docs/manage_unified_catalog/manage_subscriptions/)
...
1. A consumer initiates unsubscribe:
   ...
   2. Unsubscribe from the active subscription. For additional information, see [Manage Amplify Catalog subscriptions](/docs/manage_unified_catalog/manage_subscriptions/).
...
For additional information, see [Manage Amplify Catalog subscriptions](/docs/manage_unified_catalog/manage_subscriptions/).
