...
| `SENSEDIA_BASEURL`               | Sensedia platform base URL                                                                                              | Yes      | `https://platform-production.sensedia.com` | `https://platform-production.sensedia.com` |
...
| `SENSEDIA_ENVIRONMENTIDS`        | Comma-separated list of environment IDs to synchronize API's from. Overrides SENSEDIA_ENVIRONMENTS if both are provided | No       | `""` (all environments)                    | `123,234,345`                              |
...
| `SENSEDIA_DISCOVERIDENTITYAPIS`  | Discover identity APIs                                                                                                  | No       | `false`                                    | `true`                                     |
| `SENSEDIA_DISCOVERPRIVATEAPIS`   | Discover private APIs                                                                                                   | No       | `false`                                    | `true`                                     |
| `SENSEDIA_USEDEFAULTPLAN`        | Opt to attach the API's default plan ID to discovered instances so the gateway will apply the plan                      | No       | `false`                                    | `true`                                     |
| **Traceability Only**            |                                                                                                                         |          |                                            |                                            |
