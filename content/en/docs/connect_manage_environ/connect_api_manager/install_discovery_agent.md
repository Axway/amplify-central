...
`APIMANAGER_AUTH_PASSWORD`: The password of the API Manager user in clear text. (Surround a password with double quotes when the password contains special characters, example: "lma^]&_}}*%!#(" )
