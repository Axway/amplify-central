...
| APIMANAGER_REQUESTSETTINGS_RETRIES      | The number of retries the agent will make for an API call to API Manager. Default: 5                                                                                                                                                                                                                                                      |
| APIMANAGER_REQUESTSETTINGS_INITIALDELAY | The initial amount of time, see APIMANAGER_REQUESTSETTINGS_BACKOFF,  the agent waits between retry attempts for API calls to API Manager. Default 2s                                                                                                                                                                                      |
| APIMANAGER_REQUESTSETTINGS_BACKOFF      | When set to true, default, the agent will double the amount of time between retries when making API calls to API Manager.                                                                                                                                                                                                                 |
