...
APIMANAGER_AUTH_PASSWORD=AnApiManagerUserPassword (surround a password with double quotes when the password contains special characters, example: "lma^]&_}}*%!#(" )
#
...
| APIMANAGER_AUTH_PASSWORD                | The password created for the API Manager username created for this agent. Surround a password with double quotes when the password contains special characters, example: "lma^]&_}}*%!#("  (created in API Manager).                                                                                                                                                                                                                                        |
