...
Once you have answered all questions, the cloud formation templates are downloaded and pre-configured, the agents' configuration files are updated, the Enterprise Marketplace resources are created and the key pair is generated (if you chose to create a new service account).
