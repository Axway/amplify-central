...
* Agent Config Package (Robert?) [downloaded](<https://axway.jfrog.io/artifactory/ampc-public-generic-release/aws-agents/aws_apigw_agent_config/latest/aws_apigw_agent_config-latest.zip>) (Robert, even if I replace axway.jfrog.io with repository.axway.com, it is not valid)
