...
| **Amplify Central variables**                  |                                                                                                                                                                                                                                                                                                                                               |
| CENTRAL_APIVALIDATIONFREQUENCY                 | The frequency at which the agent validates each API Instance and Service against the dataplane (ns - default, us, ms, s, m, h). Set to 1h, minimum value of 5m.                                                                                                                                                                               |
...
| CENTRAL_USAGEREPORTING_OFFLINESCHEDULE         | Determines how often usage numbers should be saved (`@hourly` - default value and minimum, `@dayily`, `@weekly`, `@monthly`).                                                                                                                                                                                                                 |
