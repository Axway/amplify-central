...
| CENTRAL_TEAM                                                       | The name of the team in Amplify that all APIs will be linked to. Locate this at Amplify Central > Organization > Teams.                                                                                                                                                                                                                                                                                                                                                                                    |
...
| CENTRAL_AUTH_CLIENTID                                              | The name of the Service Account created in Amplify. Locate this at Amplify Central > Organization > Service Accounts.                                                                                                                                                                                                                                                                                                                                                                                      |
...
| CENTRAL_TEAM                                   | The name of the team in Amplify that all API traffic events will be linked to. Locate this at Amplify Central > Organization > Teams.                                                                                                                                                                                                                  |
...
| CENTRAL_AUTH_URL                               | The Amplify login URL: <https://login.axway.com/auth>                                                                                                                                                                                                                                                                                         |
| CENTRAL_AUTH_REALM                             | The Realm used to authenticate for Amplify. Locate this in Amplify Central > Organization > Service Accounts.                                                                                                                                                                                                                                         |
| CENTRAL_AUTH_CLIENTID                          | The name of the Service Account created in Amplify. Locate this in Amplify Central > Organization > Service Accounts. DOSA_XXXXXXXXXx                                                                                                                                                                                                                 |
| CENTRAL_AUTH_PRIVATEKEY                        | The private key associated with the Service Account.                                                                                                                                                                                                                                                                                          |
