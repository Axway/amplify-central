...
| LOG_OUTPUT                                                         | The output for the log lines (stdout, file, both). When set to `both` in the Traceability Agent only the file output will appear.                                                                                                                                                                                                                                                                                                                                                                  |
...
| CENTRAL_JOBTIMEOUT                                                 | The longest duration a job, interval and scheduled, is allowed to run before being canceled. (default `5m`)                                                                                                                                                                                                                                                                                                                                                                                        |
...
| CENTRAL_SSL_CIPHERSUITES                                           | An array of strings. It is a list of supported cipher suites for TLS versions up to TLS 1.2. If CipherSuites is nil, a default list of secure cipher suites is used, with a preference order based on hardware performance. See the [supported cipher suites](/docs/connect_manage_environ/connect_aws_gateway/agent-security-aws/).                                                                                                                                                               |
