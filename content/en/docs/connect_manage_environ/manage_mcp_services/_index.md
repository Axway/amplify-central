...
1. From the details page of your environment or from the Service Registry, click **Add Service** (located at the top right of the page). Then select **Add MCP Service**.
