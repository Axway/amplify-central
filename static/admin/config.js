...
const collections = [{
  ...
  create: false,
    ...
    description: 'Release Notes for Amplify',
    format: 'frontmatter',
}, {
  ...docsDefaults('Overview', 'Overview'),
  name: 'Overview',
  label: 'Amplify overview',
  label_singular: 'page in Amplify overview section',
  description: 'All pages related to Amplify overview',
  format: 'frontmatter',
}, {
  ...docsDefaults('Getting started', 'Getting started'),
  name: 'Getting started',
  label: 'Amplify getting started',
  label_singular: 'page in Amplify getting started section',
  description: 'All pages related to Amplify getting started',
  format: 'frontmatter',
}, {
  ...docsDefaults('integrate_with_central', 'integrate_with_central'),
  name: 'integrate_with_central',
  label: 'Integrate with Amplify',
  label_singular: 'page in Integrate with Amplify section',
  description: 'All pages related to Integrate with Amplify',
  format: 'frontmatter',
}, {
...
format: 'frontmatter',
  ...
  format: 'frontmatter',
    ...
    ...docsDefaults('manage_marketplace/customize_marketplace', 'manage_marketplace'),
    name: 'customize_marketplace',
    label: 'Customize your Marketplace',
    label_singular: 'page in Customize your Marketplace section',
    description: 'All pages related to Customize your Marketplace',
    format: 'frontmatter',
}, {
    ...docsDefaults('manage_marketplace/billing_integration', 'manage_marketplace'),
    ...
    ...docsDefaults('manage_marketplace/consumer_experience', 'manage_marketplace'),
